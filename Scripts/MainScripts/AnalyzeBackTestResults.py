...
# --- Configuration ---
search_pattern = './Results/BackTests/Backtest_Results_*.xlsx'
list_of_files = glob.glob(search_pattern)
if not list_of_files:
    raise FileNotFoundError("No se encontraron archivos de backtest en la carpeta ./Results/BackTests/")
file_path = max(list_of_files)
#file_path = './Results/BackTests/Backtest_Results_20260428_163321.xlsx'
